import {
  ...
  export const CoursePageReviewUpdate = () => {
    ...
    async function submitReview(event) {
      ...
      try {
        ...
        showNotification({ message: "Failed to update review", color: "red" });
      }
    }
    ...
    useEffect(() => {
      ...
      async function fetchReview() {
        ...
        if (response.data.data) {
          ...
          setFormRating(review.rating / 10);
          setFormProfessor(review.professorCourseId.toString());
        }
      }
